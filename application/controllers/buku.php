...
class buku extends CI_Controller
{
  ...
  {
    $data['judul'] = '<i class="fa-solid fa-sliders"></i> Kategori Buku';
  ...
  {
    $data['judul'] = '<i class="fas fa-edit"></i> Ubah Data Kategori';
    $data['user'] = $this->modeluser->cekData(['email' => $this->session->userdata('email')])->row_array();
  ...
  {
    $data['judul'] = '<i class="fa-brands fa-readme"></i> Data Buku';
    $data['user'] = $this->modeluser->cekData(['email' => $this->session->userdata('email')])->row_array();
    ...
    $config['upload_path'] = './assets/img_pustaka/';
  ...
  {
    $data['judul'] = '<i class="fas fa-edit"></i> Ubah Data Buku';
    $data['user'] = $this->modeluser->cekData(['email' => $this->session->userdata('email')])->row_array();
